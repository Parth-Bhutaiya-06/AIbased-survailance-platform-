...
| Person Detection | Bottle Detection | Cell Phone Detection |
| :---: | :---: | :---: |
| ![Person](outputs/person.png) | ![Bottle](outputs/bottle.png) | ![Cell Phone](outputs/cell%20phone.png) |

| Chair Tracking | Remote Control Tracking | Multiple Object Tracking |
| :---: | :---: | :---: |
| ![Chair](outputs/chair.png) | ![Remote Control](outputs/remote.png) | ![Multiple Objects](outputs/multiple%20object.png) |

### Processed Video Output

The processed video generated by the system is available at:
